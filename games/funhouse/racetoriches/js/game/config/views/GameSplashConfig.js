export const GAME_SPLASH_CONFIG = {
    ...
    Elements: [
        ...
        },
        {
            ...
            Elements: [
                { name: "guideRect", type: "Graphics", color: 0xff0000, width: 1685, height: 1500, alpha: 0 },
                {
                    name: "page1", type: "Comp", class: "PaytablePageV2", x: 0, y: 0,
                    Elements: [
                        { name: "screen1", type: "Sprite", image: "screen1" },
                        { name: "wildItem", type: "Comp", class: "PaytableItem", descWidth: 750, yPadding: 10, content: "wildText", style: "paytableDescStyle", x: 40, y: 480 },
                        { name: "bonusItem", type: "Comp", class: "PaytableItem", descWidth: 750, yPadding: 10, content: "scatterText", style: "paytableDescStyle", x: 470, y: 480 },
                        { name: "winUptoText", type: "Text", content: "winUptoText", fontSize: 140, style: "paytableDescStyle", x: 330, y: 1380 }
                    ]
                },
            ]
        },
        {
            ...
            Elements: [
                { name: "guideRect", type: "Graphics", color: 0x00ff00, width: 680, height: 580, lwidth: 750, lheight: 700, alpha: 0 },
        ...
        },
        {
            ...
            Elements: [
                ...
                { name: "volatilityComp", type: "Comp", class: "VolatilityComp", value: 3, textStyle: "gameFont1Style", fontSize: 45, mFontSize: 80, },
                { name: "dontShowComp", type: "Comp", class: "DontShowNextTimeComp", value: 3, textStyle: "gameFont1Style", fontSize: 63, mFontSize: 100, tickImage: "splashToggleTick_penguin", tickXPadding: 20, tickYPadding: 40 }
            ]
        }
