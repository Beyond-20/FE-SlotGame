...
import { WinningCupsRotatingComp } from "./views/comp/WinningCupsRotatingComp";
...
import { RedCrossGreenPopupComp } from "./views/comp/RedCrossGreenPopupComp";
    ...
    getGameClass(string, config) {
        ...
        switch (string) {
            ...
            case "PostMegaBoardScreenComp":
                ...
                break;
            case "WinningCupsRotatingComp":
                element = new WinningCupsRotatingComp(config);
                break;
            ...
            case "PostMegaBoardWinningPopupComp":
                ...
                break;
            case "RedCrossGreenPopupComp":
                element = new RedCrossGreenPopupComp(config);
                break;
            case "NoPortraitView":
