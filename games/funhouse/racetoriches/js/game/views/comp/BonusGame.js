...
export class BonusGame extends SlotGameBonusComp {
    ...
    showSlotMachine() {
        ...
        slot.reelFrame.visible = false;
        slot.greenManIcon.visible = false;
    ...
    onFeatureResponse() {
        ...
        this.diceRotatingComp.showGreenDiceAnimation(arr[0]);
    ...
    hideMegaBoard() {
        ...
        slot.reelFrame.visible = true;
        slot.greenManIcon.visible = true;
