...
export class PostMegaBoardScreenComp extends LibView {
    constructor(config, layoutconfig) {
        ...
        this.winningCupsRotatingComp = this.postMegaboardElements.elementsList["winningCupsRotatingComp"];
        this.cupsGuideRect = this.winningCupsRotatingComp.elementsList["guideRect"];
        this.gold10x = this.winningCupsRotatingComp.elementsList["gold10x"];
        this.silver5x = this.winningCupsRotatingComp.elementsList["silver5x"];
        this.silver4x = this.winningCupsRotatingComp.elementsList["silver4x"];
        this.bronze3x = this.winningCupsRotatingComp.elementsList["bronze3x"];
        this.bronze2x = this.winningCupsRotatingComp.elementsList["bronze2x"];
        this.trophyArr = [this.bronze2x, this.bronze3x, this.silver4x, this.silver5x, this.gold10x]
    ...
    showPostMegaBoard() {
        ...
        this.winningCupsRotatingComp.trophyRotate();
    }
    ...
    handleClick() {
        this.winningCupsRotatingComp.increaseSpeed();
    ...
    onFeatureResponse() {
        setTimeout(() => {
            this.winningCupsRotatingComp.showWinningCup();
        }, 6500);
    }
    ...
    resizeViewComponents() {
        ...
        CoreLib.UIUtil.adjustElement(this.gold10x);
        CoreLib.UIUtil.positionObjectForDevice(this.gold10x);
