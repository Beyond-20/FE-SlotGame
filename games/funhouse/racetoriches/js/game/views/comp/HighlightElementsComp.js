...
let _1RemovedSymb = [{ x: 1420, y: 380, scale: { x: 0.3, y: 0.3 } }]
let _2RemovedSymb = [{ x: 1420, y: 335, scale: { x: 0.2, y: 0.2 } }, { x: 1420, y: 445, scale: { x: 0.2, y: 0.2 } }];
let _3RemovedSymb = [{ x: 1380, y: 335, scale: { x: 0.18, y: 0.18 } }, { x: 1460, y: 335, scale: { x: 0.18, y: 0.18 } }, { x: 1420, y: 445, scale: { x: 0.18, y: 0.18 } }];
let _4RemovedSymb = [{ x: 1380, y: 335, scale: { x: 0.18, y: 0.18 } }, { x: 1460, y: 335, scale: { x: 0.18, y: 0.18 } }, { x: 1380, y: 445, scale: { x: 0.18, y: 0.18 } }, { x: 1460, y: 445, scale: { x: 0.18, y: 0.18 } }];
let _5RemovedSymb = [{ x: 1380, y: 325, scale: { x: 0.14, y: 0.14 } }, { x: 1460, y: 325, scale: { x: 0.14, y: 0.14 } }, { x: 1380, y: 400, scale: { x: 0.14, y: 0.14 } }, { x: 1460, y: 400, scale: { x: 0.14, y: 0.14 } }, { x: 1420, y: 475, scale: { x: 0.14, y: 0.14 } }];
let _6RemovedSymb = [{ x: 1380, y: 325, scale: { x: 0.14, y: 0.14 } }, { x: 1460, y: 325, scale: { x: 0.14, y: 0.14 } }, { x: 1380, y: 400, scale: { x: 0.14, y: 0.14 } }, { x: 1460, y: 400, scale: { x: 0.14, y: 0.14 } }, { x: 1380, y: 475, scale: { x: 0.14, y: 0.14 } }, { x: 1460, y: 475, scale: { x: 0.14, y: 0.14 } }];
...
export class HighlightElementsComp extends LibView {
    ...
    showWinningElement(value) {
        ...
        this.element.x = this.guideRect.width / 2;
