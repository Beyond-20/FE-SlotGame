...
import { spinControllerRC } from "../../../../../../slot_core/corelib/views/slotmachine/SpinControllerReelSizeChange";
import { spinWinControllerRC } from "../../../../../../slot_core/corelib/views/slotmachine/SpinWinReelChangeControllerStandard";
...
export class GameApp extends Application {
    ...
    createGameView() {
        ...
        CoreLib.EventHandler.dispatchEvent(CoreLib.SlotEvents.SET_SPIN_CONTROLLER, spinControllerRC);
        CoreLib.EventHandler.dispatchEvent(CoreLib.SlotEvents.SET_WIN_CONTROLLER, spinWinControllerRC);
        CoreLib.EventHandler.addEventListener("FS_REELFRAME_ANIMATION_DONE", this.startFS.bind(this));
    ...
    showBonusTriggerEnterPopup() {
        if (slotModel.getFeatureType() == CoreLib.Model.GameConfig.featureTypes.freespins) {
            ...
            msgObj.message2 = data.totalCount;
            msgObj.message3 = CoreLib.Util.getContent("numberOfFS");
    ...
    onFSEntryDoneClicked() {
        ...
        CoreLib.EventHandler.dispatchEvent("SHOW_FS_REELFRAME");
    }

    startFS() {
        CoreLib.EventHandler.dispatchEvent("CREATE_SYMBOL_ON_LAST_ROW");
        this.startFreespins();
    }
    ...
    endFreespinRoundFromPopup() {
        ...
        CoreLib.EventHandler.dispatchEvent("SHOW_INITIAL_REELFRAME");
    }
