...
const GAME_COMMON = [
  {TYPE: "common", NAME : "tournamentAssets", ASSETTYPE : "sequence", SPRITESHEETS : [2,2,2]},
                    ...
                    {TYPE: "game", NAME : "bigWinAnim", ASSETTYPE : "sequence", SPRITESHEETS : [5,4,2]},
                    ...
                    {TYPE: "game", NAME : "symbolAnimation_11", ASSETTYPE : "sequence", SPRITESHEETS: [2,1,1]},
                    {TYPE: "game", NAME : "symbolAnimation_11_landing.json", ASSETTYPE : "sprite"},
                    {TYPE: "game", NAME : "bonusGame.json", ASSETTYPE : "sprite"},
                    {TYPE: "game", NAME : "bonusAnimations", ASSETTYPE : "sequence", SPRITESHEETS : [14,6,3]},
