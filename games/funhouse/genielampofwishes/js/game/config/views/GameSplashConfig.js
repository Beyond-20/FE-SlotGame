export const GAME_SPLASH_CONFIG = {
    ...
    Elements : [
        {name : "pagesComp", type : "Comp", class :"PaytablePages", x: 0, y : 0, maxWidth : 0.60, maxHeight : 0.9,
            Elements : [
                {name : "guideRect", type : "Graphics", color : 0xff0000, width : 1650, height : 1750, alpha : 0},
                {name : "page1", type : "Comp", class : "PaytablePage", x: 0, y :0,
                    Elements : [
                        {name : "screen1", type : "Sprite", image : "screen1"},
                        {name : "wildItem", type : "Comp", class : "PaytableItem", descWidth : 700, yPadding : 10, content : "wildText", style : "paytableDescStyle", x : 60, y : 560},
                        {name : "bonusItem", type : "Comp", class : "PaytableItem", descWidth : 700, yPadding : 10, content : "scatterText", style : "paytableDescStyle", x : 470, y : 560},
        ...
        {name : "logoContainer", type : "Comp", class : "PixiContainer",scale : 1, pScale : 1,
            Elements: [
                {name : "guideRect", type : "Graphics", color : 0x00ff00, width :750, height :700,lwidth :750, lheight :700, alpha : 0},
                {name : "splashlogo", type : "Sprite", image : "gamelogo_splash", anchor : { x:0.5, y : 0.5 }, lScale : 1.3,},
            ]
        },
