...
export class YellowCrossPurplePopupComp extends LibView {
    constructor(config, layoutconfig) {
        ...
        this.monopolyManImage = this.redCrossGreenElements.elementsList["monopolyManImage"];
        ...
        CoreLib.EventHandler.addEventListener("SHOW_BOY_CROSS_MONOPOLY_MAN_SCREEN", this.showBoyCrossMonopolyManScreen.bind(this));
    }

    showBoyCrossMonopolyManScreen() {
        this.visible = true;
    ...
    endMegaboard() {
        ...
        CoreLib.EventHandler.dispatchEvent("BOY_CROSSED_MONOPOLY_MAN_POPUP_SHOWN_DONE");
    }
    ...
    resizeViewComponents() {
        ...
        CoreLib.UIUtil.adjustElement(this.monopolyManImage);
        CoreLib.UIUtil.positionObjectForDevice(this.monopolyManImage);
