...
export class GameSlotMachineComp extends SlotMachineComp {
    constructor(config) {
        ...
        this.monopolyManIcon = this.elementsList["monopolyManIcon"];
        this.monopolyManIcon.visible = true;
        this.slotMachine = this.elementsList["slotMachine"];

        this.monopolyWildAnim = this.elementsList["monopolyWildAnim"];
        this.monopolyWildAnim.visible = false;
        this.monopolyWildAnim.onComplete = this.onMonopolyWildAnimComplete.bind(this);
        ...
        CoreLib.EventHandler.addEventListener("INITIATE_MONOPOLY_WILD", this.onMonopolyWildTriggered.bind(this));
        CoreLib.EventHandler.addEventListener("MONOPOLY_WILD_PLACEMENT_DONE", this.onReelSpinCompleted.bind(this))
    ...
    showMegaBoardTriggeredAnim() {
        ...
        this.monopolyManIcon.playAnimation("win", true);
        CoreLib.EventHandler.dispatchEvent("PLAY_GREEN_JUMP_TO_MOVE_SOUND");
        this.megaboardTriggeredAnim.playAnimation("mega_start", false);
        setTimeout(() => {
            this.monopolyManIcon.playAnimation("run_start", true);
            ...
            this.monopolyManIcon.playAnimation("run_cicly", true);
            CoreLib.EventHandler.dispatchEvent("PLAY_GREEN_RIDE_GENERAL_GAME_SOUND");
            this.megaboardTriggeredAnim.playAnimation("mega_idle", true);
        }, 1000);
        CoreLib.AnimationManager.animateTween(this.monopolyManIcon, 5.5, { delay: 1.2, x: this.monopolyManIcon.x + 3500 });
        setTimeout(this.stopMegaBoardTriggeredAnim.bind(this), 2000);
        this.ismegaboardTriggered = true;
    }
    stopMegaBoardTriggeredAnim() {
        this.megaboardTriggeredAnim.playAnimation("mega_stop", false);
        ...
        if (this.ismegaboardTriggered) {
            this.monopolyManIcon.playAnimation("run_cicly", true);
            this.monopolyManIcon.x = -3500;
            CoreLib.AnimationManager.animateTween(this.monopolyManIcon, 4.5, { delay: 0.8, x: this.monopolyManIcon.configData.x });
            setTimeout(() => {
                this.monopolyManIcon.playAnimation("run_stop", true);
                this.monopolyManIcon.playAnimation("idle_sleep", true);
            }, 5000);
        }
        this.ismegaboardTriggered = false;
    }
    ...
    onWinSpinTriggered(winSpinPosition) {
        ...
        setTimeout(() => {
            this.monopolyManIcon.playAnimation("run_start", true);
            CoreLib.EventHandler.dispatchEvent("PLAY_GREEN_RIDE_GENERAL_GAME_SOUND");
            CoreLib.EventHandler.dispatchEvent("PLAY_CURTAIN_EFFECT_SOUND");
        }, 1000);
        setTimeout(() => {
            this.monopolyManIcon.playAnimation("run_cicly", true);
            this.winSpinAnim.visible = true;
            this.winSpinAnim.playAnimation("win_spin_close_open", false);
            CoreLib.EventHandler.dispatchEvent("PLAY_WIN_SPIN_SOUND");
        }, 1000);
        CoreLib.AnimationManager.animateTween(this.monopolyManIcon, 5.5, { delay: 1.2, x: this.monopolyManIcon.x + 3500, onComplete: this.stopGreenRideSound.bind(this) });
    ...
    onRainbowRespinTriggered(respinPosition) {
        ...
        setTimeout(() => {
            ...
            this.rainbowRespinAnim.playAnimation("rainbow_respin_close_open", false);
            this.monopolyManIcon.playAnimation("run_cicly", true);
    ...
    startShowingRespinSymbols() {
        ...
        this.rainbowAnticipation.playAnimation("animation", true);
        this.greenAnticipation.playAnimation("animation", true);
    ...
    //jockeyWild
    onMonopolyWildTriggered(positions) {
        ...
        setTimeout(() => {
            this.monopolyManIcon.playAnimation("run_cicly", true);
            this.monopolyWildAnim.visible = true;
            this.monopolyWildAnim.playAnimation("monopoly_wilds_close_open",false);
            CoreLib.EventHandler.dispatchEvent("PLAY_MONOPOLY_WILD_SOUND");
        }, 1000);
        CoreLib.AnimationManager.animateTween(this.monopolyManIcon, 5.5, { delay: 1.2, x: this.monopolyManIcon.x + 3500, onComplete: this.stopGreenRideSound.bind(this) });
    ...
    resizeViewComponents() {
        ...
        this.resizeChildren();
        CoreLib.UIUtil.adjustElement(this.monopolyManIcon);
        CoreLib.UIUtil.setPositionBasedOnDevice(this.monopolyManIcon);
    }
