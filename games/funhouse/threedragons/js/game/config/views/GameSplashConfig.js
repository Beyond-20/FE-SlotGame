export const GAME_SPLASH_CONFIG = {
    ...
    Elements: [
        ...
        },
        {
            ...
            Elements: [
                { name: "guideRect", type: "Graphics", color: 0x000000, width: 1680, height: 1630, alpha: 0 },
                {
                    name: "page1", type: "Comp", class: "PaytablePageV2", x: 0, y: 0,
                    Elements: [
                        { name: "screen1", type: "Sprite", image: "screen1" },
                        { name: "bonusItem", type: "Comp", class: "PaytableItem", descWidth: 1300, yPadding: 10, fontSize: 50, mfontSize: 70, content: "bonusPayoutText", style: "paytableDescStyle", align: "left", x: 100, y: 520 },
                        { name: "winUptoText", type: "Text", content: "winUptoText", fontSize: 80, style: "paytableDescStyle", x: 360, y: 1500 }
                    ]
                },
            ]
        },
        {
            ...
            Elements: [
                { name: "guideRect", type: "Graphics", color: 0x000000, width: 800, height: 600, alpha: 0 },
        ...
        },
        {
            ...
            Elements: [
                { name: "guideRect", type: "Graphics", color: 0x000000, width: 680, height: 510, pWidth: 950, pHeight: 800, lWidth: 850, lHeight: 720, alpha: 0 },
