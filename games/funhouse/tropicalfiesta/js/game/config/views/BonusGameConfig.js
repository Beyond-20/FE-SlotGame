                ...
                Elements: [
                    ...
                    {name : "leftPanel", type : "Comp", class : "PixiContainer", x : 0, y : 510, px : 100, py : 200,
                        Elements : [
                            ...
                            {name : "creditPrizeTitle", type : "Text", content : "creditPrizeTitle", style : "prizeTitleStyle", fontSize : 56, anchor : {x:0.5, y : 0}, x : 230, y : 40},
                            ...
                            {name : "awardMinText", type : "Text", content : "minText", style : "minmaxTextStyle", fontSize : 44, anchor : {x:0.5, y : 0}, x : 230, y : 370},
                    ...
                    {name: "rightPanel", type: "Comp", class: "PixiContainer", x: 1612, y: 510, px : 620, py : 200,
                        Elements: [
                            ...
                            {name : "fsNumberText", type : "Text", contentText : "20", style : "awardValueStyle", fontSize : 66, anchor : {x:0.5, y : 0}, x : 234, y : 240},
