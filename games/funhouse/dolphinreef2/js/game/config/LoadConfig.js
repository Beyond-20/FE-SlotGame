...
const GAME_COMMON = [
    ...
    { TYPE: "game", NAME: "symbolAnimation_WD_expanding_dolphin.json", ASSETTYPE: "sprite" },
    { TYPE: "game", NAME: "symbolAnimation_WD_expanding_framecicly.json", ASSETTYPE: "sprite" },
    { TYPE: "game", NAME: "symbolAnimation_WD_expanding_frameopen.json", ASSETTYPE: "sprite" },
...
const GAME_DESKTOP = [{ TYPE: "common", NAME: "ControlsUI.json", ASSETTYPE: "sprite" }, { TYPE: "game", NAME: "gamebg", ASSETTYPE: "sequence", SPRITESHEETS: [2, 1, 1] }];
const GAME_MOBILE = [{ TYPE: "common", NAME: "ControlsUIMobile.json", ASSETTYPE: "sprite" }, { TYPE: "game", NAME: "gamebg", ASSETTYPE: "sequence", SPRITESHEETS: [2, 1, 1] }];
const GAME_TABLET = [{ TYPE: "common", NAME: "ControlsUIMobile.json", ASSETTYPE: "sprite" }, { TYPE: "game", NAME: "gamebg", ASSETTYPE: "sequence", SPRITESHEETS: [2, 1, 1] }];
