    ...
    Elements : [
        ...
        {name : "winAmountComp", type : "Comp", class : "SlotWinAmountSequentialSpineComp", x: 0, y : 50, yPadding : 0, loopAfterEnd : false,
            ...
            Elements :[
                ...
                {name : "bigwinbg", type : "Sprite", image : "bigwinbg", y : 360, scale:{ x: 1.2, y: 0.7 }},
                ...
                {name : "unbelievableWinAnim", type : "Spine", spineName: "popups", defaultState : "unbelievable_idle", start: "unbelievable_start", idleState: "unbelievable_idle", end : "unbelievable_end", loop : true, scale : 0.55, yPaddingPerc : 0.47},
                {name : "winText", type : "Text", style : "winAmountStyle", anchor : {x : 0.5, y : 0.5}, x : 610, y : 450}
            ]
        },
