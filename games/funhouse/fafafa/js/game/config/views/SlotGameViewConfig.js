...
import { FAFAFA_MESSAGE_POPUP_CONFIG } from './FafafaMessagePopupConfig'
import { BUY_BONUS_POPUP_CONFIG } from './BuyBonusPopupConfig'
...
export const SLOT_GAMEVIEW_CONFIG = {
    ...
    Elements : [
        ...
        FAFAFA_MESSAGE_POPUP_CONFIG,
        BUY_BONUS_POPUP_CONFIG,
        ALERT_POPUP_CONFIG
    ]
}
